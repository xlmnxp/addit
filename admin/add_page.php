...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active"><?= $language->add_page ?></li>
        </ol>
    </div><!--/.row-->

    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><?= $language->add_page ?></h1>
        </div>
    </div><!--/.row-->
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading"><?= $language->add_page ?></div>
                    ...
                    <form role="form" method="post">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="title" placeholder="<?= $language->page_title ?>" />
                            </div>
                            <div class="form-group">
                                <label><?= $language->page_template ?></label>
                                <textarea class="form-control" id="page_template" name="template" placeholder="<?= $language->page_template ?>"></textarea>
                            </div>
