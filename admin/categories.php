...
?>
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active"><?= $language->view_all_categories ?></li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header"><?= $language->view_all_categories ?></h1>
			</div>
		</div><!--/.row-->
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
                    <?= $language->categories ?>
                    <a href="add_category.php" class="btn btn-primary"><svg class="glyph stroked plus sign" style="height: 1.5em;width: 1.5em;margin:2px;"><use xlink:href="#stroked-plus-sign"/></svg>&nbsp;<?= $language->add_category ?></a>                    
                </div>
				<div class="panel-body">
					<table id="categories" class="table table-striped" data-toggle="table" data-url="tables/categories.php"
						...
						<thead>
                            <tr>
                                ...
                                <th data-field="description" data-sortable="true"><b><?= $language->description ?></b>&nbsp;</th>
	...
	<script>
        function editBtns(value,row,index) {
            return '<center><a class="btn btn-primary btn-block text-left" href="edit_category.php?id='+ row.id +'"><svg class="glyph stroked pencil" style="height: 1.5em;width: 1.5em;margin:2px;"><use xlink:href="#stroked-pencil"/></svg>&nbsp;<?= $language->edit ?></a><a class="btn btn-danger btn-block text-left" onclick="deleteCategory(\''+row.id+'\')"><svg class="glyph stroked trash" style="height: 1.5em;width: 1.5em;margin:2px;"><use xlink:href="#stroked-trash"/></svg>&nbsp;<?= $language->delete ?></a></center>'
        }
        ...
        function deleteCategory(id) {
            swal({
                ...
                $.getJSON('delete.category.php?id='+id, function (data) {
